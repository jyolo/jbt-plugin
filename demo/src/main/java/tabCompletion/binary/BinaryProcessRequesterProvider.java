...
import static tabCompletion.general.DependencyContainer.instanceOfGson;
import static tabCompletion.general.StaticConfig.*;
import static tabCompletion.general.Utils.executeThread;

import com.intellij.openapi.diagnostic.Logger;
import com.intellij.util.ObjectUtils;
import tabCompletion.binary.VoidBinaryProcessRequester;
import tabCompletion.binary.*;
import tabCompletion.binary.BinaryProcessRequester;
import tabCompletion.binary.BinaryRun;
import tabCompletion.binary.exceptions.BinaryRequestTimeoutException;
import java.util.Collections;
import java.util.concurrent.Future;

public class BinaryProcessRequesterProvider {
  private final tabCompletion.binary.BinaryRun binaryRun;
  ...
  private tabCompletion.binary.BinaryProcessRequester binaryProcessRequester;
  ...
  private BinaryProcessRequesterProvider(
      tabCompletion.binary.BinaryRun binaryRun,
