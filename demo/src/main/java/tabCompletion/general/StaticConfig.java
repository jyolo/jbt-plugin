...
import static tabCompletion.general.Utils.isUnitTestMode;
...
import tabCompletion.binary.exceptions.InvalidVersionPathException;
...
public class StaticConfig {
  // Must be identical to what is written under <id>tabCompletion.TabNine</id> in plugin.xml !!!
  public static final String TABNINE_PLUGIN_ID_RAW = "tabCompletion.TabNine";
