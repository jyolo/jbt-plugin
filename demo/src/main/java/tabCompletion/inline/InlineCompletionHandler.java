...
import static tabCompletion.general.Utils.*;
import static tabCompletion.prediction.CompletionFacade.getFilename;
...
import tabCompletion.binary.requests.notifications.shown.SnippetShownRequest;
import tabCompletion.binary.requests.notifications.shown.SuggestionDroppedReason;
import tabCompletion.binary.requests.notifications.shown.SuggestionShownRequest;
import tabCompletion.capabilities.SuggestionsMode;
...
import tabCompletion.inline.CompletionAdjustment;
import tabCompletion.inline.CompletionPreview;
import tabCompletion.inline.CompletionTracker;
import tabCompletion.inline.InlineCompletionCache;
import tabCompletion.inline.OnCompletionPreviewUpdatedCallback;
...
//    }
  ...
  private List<TabNineCompletion> retrieveInlineCompletion(
      ...
      Integer tabSize,
      @NotNull CompletionAdjustment completionAdjustment) {
    @Nullable AutocompleteResponse completionsResponse =
